...
public class H2SqlParser {
    ...
    public static Map<String, String> parseSchema() {
        try {
            String schemaSql = IOUtils.toString(
                    H2SqlParser.class.getResourceAsStream("/db/h2/schema.txt"));
            ...
            for (String schema : schemaArray) {
                ...
                for (String sql : sqlArray) {
                    if (StringUtils.isNotBlank(sql) && sql.startsWith("CREATE TABLE")) {
    ...
    public static String generateInsertSql(Object entity, String tableName, String mockerInfo) {
        ...
        try {
            ...
            for (String sql : sqlArray) {
                ...
                if (sql.startsWith("CREATE TABLE")) {
                    ...
                    fieldName = StringUtils.substringBefore(sql, " ");
                    if (StringUtils.isBlank(fieldName)) {
                        continue;
                    }
                    if (fieldName.equalsIgnoreCase("id")) {
                        sqlBuilder.append("DEFAULT,");
                    } else if (fieldName.equalsIgnoreCase("dataCreateTime")) {
