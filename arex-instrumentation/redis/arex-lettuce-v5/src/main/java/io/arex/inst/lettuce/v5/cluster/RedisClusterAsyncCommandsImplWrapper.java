...
import io.arex.inst.lettuce.v5.RedisCommandBuilderImpl;
...
public class RedisClusterAsyncCommandsImplWrapper<K, V> extends RedisAdvancedClusterAsyncCommandsImpl<K, V> {
    ...
    public RedisClusterAsyncCommandsImplWrapper(StatefulRedisClusterConnection<K, V> connection, RedisCodec<K, V> codec) {
