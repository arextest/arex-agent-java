...
public class RedisAsyncCommandsImplWrapper<K, V> extends RedisAsyncCommandsImpl<K, V> {
    ...
    public RedisFuture<Long> del(K... keys) {
        return redisCommandWrapper.del(this, getRedisUri(), keys);
    }
    ...
    public RedisFuture<Long> exists(K... keys) {
        return redisCommandWrapper.exists(this, getRedisUri(), keys);
    }
    ...
    public RedisFuture<V> getdel(K key) {
        return redisCommandWrapper.getdel(this, getRedisUri(), key);
    }

    @Override
    public RedisFuture<V> getex(K key, GetExArgs args) {
        return redisCommandWrapper.getex(this, getRedisUri(), key, args);
    }
    ...
    public RedisFuture<List<K>> keys(K pattern) {
        return redisCommandWrapper.keys(this, getRedisUri(), pattern);
    }

    @Override
    public RedisFuture<Long> keys(KeyStreamingChannel<K> channel, K pattern) {
        return redisCommandWrapper.keys(this, getRedisUri(),channel, pattern);
    }
    ...
    public RedisFuture<List<V>> lpop(K key, long count) {
        return redisCommandWrapper.lpop(this, getRedisUri(), key, count);
    }
    ...
    public RedisFuture<List<KeyValue<K, V>>> mget(K... keys) {
        return redisCommandWrapper.mget(this, getRedisUri(), keys);
    }
    ...
    public RedisFuture<Long> mget(KeyValueStreamingChannel<K, V> channel, K... keys) {
        return redisCommandWrapper.mget(this, getRedisUri(), channel,keys);
    }
    ...
    public RedisFuture<String> mset(Map<K, V> map) {
        return redisCommandWrapper.mset(this, getRedisUri(), map);
    }

    @Override
    public RedisFuture<Boolean> msetnx(Map<K, V> map) {
        return redisCommandWrapper.msetnx(this, getRedisUri(), map);
    }
    ...
    public RedisFuture<V> setGet(K key, V value) {
        return redisCommandWrapper.setGet(this, getRedisUri(), key, value);
    }

    @Override
    public RedisFuture<V> setGet(K key, V value, SetArgs setArgs) {
        return redisCommandWrapper.setGet(this, getRedisUri(), key, value, setArgs);
