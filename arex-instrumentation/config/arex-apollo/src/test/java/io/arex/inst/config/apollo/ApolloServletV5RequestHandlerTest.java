...
class ApolloServletV5RequestHandlerTest {
    static ApolloServletV5RequestHandler target;
    static MockedStatic<ApolloConfigHelper> mockStaticHelper;

    @BeforeAll
    static void setUp() {
        target = new ApolloServletV5RequestHandler();
    ...
    @Test
    void name() {
        assertNotNull(new ApolloServletV5RequestHandler().name());
    }
