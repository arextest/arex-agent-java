...
public class HealthManager {
    ...
    private static final RecordRateChecker DATA_SERVICE_CHECKER = new RecordRateChecker(TimeUnit.MILLISECONDS.toNanos(300));
    private static final RecordRateChecker BALANCE_CHECKER = new RecordRateChecker(TimeUnit.MILLISECONDS.toNanos(3000));
